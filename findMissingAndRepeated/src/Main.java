...
/*
        ...
        findMissingAndReplace(a, aa.length);
    }

    public static void findMissingAndReplace(ArrayList<Integer> a, int n) {
        int missing = 0, repeated = 0, i;
